...
RUN_USBC_POWER="${RUN_USBC_POWER:-1}"
...
USBC_POWER_DISABLE_D3COLD="${USBC_POWER_DISABLE_D3COLD:-1}"
USBC_POWER_KEEP_NHI="${USBC_POWER_KEEP_NHI:-1}"
...
require_root() {
  ...
  exec sudo \
    ...
    USBC_POWER_DISABLE_D3COLD="$USBC_POWER_DISABLE_D3COLD" \
    USBC_POWER_KEEP_NHI="$USBC_POWER_KEEP_NHI" \
